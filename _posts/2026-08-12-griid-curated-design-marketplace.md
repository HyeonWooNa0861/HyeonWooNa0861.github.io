...
> **핵심 메시지:** 독립 디자이너의 작품 발견, 관심 저장, 입찰과 낙찰 이후의 흐름을 하나의 이미지 중심 경험으로 연결하는 것이 gri:d의 핵심 가치다.
...
gri:d의 핵심 가치는 독립 디자이너의 작품 발견, 저장, 입찰과 낙찰 이후 흐름을 하나의 이미지 중심 경험으로 연결하는 데 있다. 현재의 큐레이션 기반을 유지하면서 거래 데이터와 운영 기능을 연결하면 작품 감상에서 실제 소장까지 이어지는 플랫폼으로 확장할 수 있다.
