...
1. 자율주행에서 perception과 planning을 완전히 분리하면 어떤 장단점이 생기는가?
2. HD map 기반 접근과 camera-first learning 접근의 차이를 설명하라.
3. Occupancy representation이 end-to-end driving으로 가는 bridge가 되는 이유는 무엇인가?
