...
| 페이지 | 원문 주제 | 본문 대응 |
|---:|---|---|
| 1–3 | 상속의 정의와 기본 문법 | 1–2절 |
| 4–6 | `private`, `protected`, 상속 접근 지정자 | 3–5절 |
| 7–9 | 생성·소멸 순서, 기본 생성자, 함수 숨김 | 6–8절 |
| 10–12 | casting, 다중 상속, 요약 | 9–10절·마지막 정리 |

12쪽 전체를 페이지 이미지로 대조했다. `Circle::area()`의 `3.14159 * r * r`는 상속 문법을 보여 주는 예제 함수의 단순 계산일 뿐, 상속 규칙이나 뒤의 전개가 의존하는 핵심 수식은 아니다. 나머지도 접근 제어와 객체 수명에 관한 C++ 규칙이므로 존재하지 않는 수학적 증명을 덧붙이지 않았다.
