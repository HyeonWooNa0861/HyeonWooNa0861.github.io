...
| 이름 | 직관 |
|---|---|
| Manhattan norm / `l1` | 좌표축을 따라 이동한 거리 |
| Euclidean norm / `l2` | 직선 거리 |
...
| 행렬 | 조건 |
|---|---|
| SPD | symmetric이고 `x^T A x > 0` for `x != 0` |
| SPSD | symmetric이고 `x^T A x >= 0` |
