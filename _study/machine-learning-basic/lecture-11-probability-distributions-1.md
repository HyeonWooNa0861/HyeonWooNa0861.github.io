...
우리가 계산하는 확률은 보통 `P(X >= 1)`처럼 확률변수 위의 사건에 대한 확률이다.
...
1. 동전 두 번 던지기에서 `P(X>=1)`은 어떤 사건의 확률인가?
2. Joint PMF는 단순히 두 PMF를 곱한 것인가? 언제 곱할 수 있는가?
3. 연속확률변수에서 "정확히 2시"에 도착할 확률이 0인 이유는 무엇인가?
