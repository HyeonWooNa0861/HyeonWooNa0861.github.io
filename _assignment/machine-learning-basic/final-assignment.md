...
<summary markdown="span">1-1. 양성 판정을 받은 부품이 실제 불량일 확률 $$P(D\mid T=+)$$를 구하라.</summary>
...
<details markdown="block">
<summary markdown="span">변형 1. 음성 판정을 받은 부품이 실제 불량일 확률 $$P(D\mid T=-)$$를 구하라.</summary>
...
<details markdown="block">
<summary markdown="span">2-1. $$\theta^{(0)}=\begin{bmatrix}0\\0\end{bmatrix}$$일 때 한 번 update한 결과를 구하라.</summary>
...
<details markdown="block">
<summary markdown="span">2-2. $$\theta^{(0)}=\begin{bmatrix}2\\-1\end{bmatrix}$$일 때 한 번 update한 결과를 구하라.</summary>
...
<details markdown="block">
<summary markdown="span">변형 2. Newton method를 $$\theta^{(0)}=\begin{bmatrix}0\\0\end{bmatrix}$$에서 한 번 적용하면 어디로 가는가?</summary>
...
<details markdown="block">
<summary markdown="span">3-1. $$f(x)=\lvert x\rvert$$, $$x\in\mathbb{R}$$가 convex인지 판단하라.</summary>
...
<details markdown="block">
<summary markdown="span">3-2. $$g(x)=\sin x$$, $$x\in\mathbb{R}$$가 convex인지 판단하라.</summary>
...
<details markdown="block">
<summary markdown="span">변형 1. $$g(x)=\sin x$$는 구간 $$[\pi,2\pi]$$에서 convex인가?</summary>
...
<details markdown="block">
<summary markdown="span">변형 2. 2번의 함수 $$f(\theta_1,\theta_2)$$는 convex인가?</summary>
...
<details markdown="block">
<summary markdown="span">4-1. MLE $$\theta_{\mathrm{ML}}$$을 구하라.</summary>
...
<details markdown="block">
<summary markdown="span">4-2. 새로운 입력 $$x_*=2$$에 대한 출력 $$y_*$$의 예측분포를 구하라.</summary>
...
<details markdown="block">
<summary markdown="span">변형 1. 같은 데이터에서 $$x_*=3$$의 점 예측은 무엇인가?</summary>
...
<details markdown="block">
<summary markdown="span">변형 2. Gaussian prior $$\theta\sim\mathcal{N}(0,I)$$를 추가하면 MAP objective는 어떻게 쓰는가?</summary>
...
<details markdown="block">
<summary markdown="span">1. Bayes 정리에서 evidence $$P(T=+)$$는 왜 필요한가?</summary>
...
<details markdown="block">
<summary markdown="span">5. Polynomial regression에서 $$\Phi$$ 행렬은 어떻게 만드는가?</summary>
